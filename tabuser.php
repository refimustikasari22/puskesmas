...
include  'fungsi.php';
$jmldatahalaman = 10;
$jmldata = count(query("SELECT * FROM user WHERE level != ('pasien') AND level != ('pasienbaru') "));
...
// ORDER BY nama ASC 
$pasien = mysqli_query($conn, "SELECT * FROM user WHERE level != ('pasien') AND level != ('pasienbaru') LIMIT $awaldata,$jmldatahalaman");
...
<div class="d-flex bd-highlight mb-3">
        <div class="ms-auto p-2 bd-highlight"><a href="logout.php" class="btn btn-danger me-md-2">
                <span class="text">Logout</span>
            </a> </div>
        <div class="p-2 bd-highlight"><a href="reguser.php" class="btn btn-info text-white me-md-2">
    ...
    <ul class="nav nav-pills nav-fill">
        <li class=" nav-item">
            <a class="nav-link active" style="color: black; background-color: #f8f9fa;" aria-current="page" href="admin.php">Tabel Pasien</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link" style=" color: white; background-color: #a5c422;" href="tabuser.php">Tabel User</a>
        </li>
    </ul>
    <br>
    <br>
    ...
    <div class="container">
        ...
        <a href="reguser.php" class="btn btn-info text-white">Registrasi</a> -->
        <h3 class="text-center p-3">Tabel Admin & Dokter</h3>
                ...
                <tbody>
                    <?php foreach ($pasien as $row) : ?>
                        <tr>
                            ...
                            <td><?= $row["alamat"]; ?></td>
                            <td>
                                <a class="btn btn-warning text-white" href="edituser.php?id=<?= $row["id"]; ?>" onclick="return confirm('Yakin?')" class="text-white text-decoration-none">Edit</a>
                                <a class="btn btn-secondary text-white" href="hapususer.php?id=<?= $row["id"]; ?>" onclick="return confirm('Yakin?')" class="text-white text-decoration-none">Hapus</a>
                            </td>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <select id="poli" name="poli" class="form-select">
                                       ...
                                       <option value="MTBS">Manajemen Terpadu Balita Sakit (MTBS)</option>
                                    </select>
                                </div>
                                <div class="col">
