        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col m-3">
                    ...
                    <input type="text" class="form-control" id="jawab" name="jawab"  value="<?= $blt["jawab"]; ?>">
                </div>
            </div>
            <div class="row">
                <div class="col m-3">
                    <label for="kawin" class="form-label">Status Perkawinan</label>
                    <select class="form-select" id="kawin" name="kawin">
                        <option selected><?= $blt["kawin"]; ?></option>
                ...
                <div class="col m-3">
                    ...
                    <input type="text" class="form-control" id="pekerjaan" name="pekerjaan"  value="<?= $blt["pekerjaan"]; ?>">
                </div>
            </div>
            <div class="row">
                <div class="col m-3">
                    <label for="pembayaran" class="form-label">Cara Pembayaran</label>
                    <select class="form-control" name="pembayaran" id="pembayaran">
                        <option selected><?= $blt["pembayaran"]; ?></option>
            ...
            <div class="m-3">
                ...
                <a class="text-white text-decoration-none btn btn-danger" href="admin.php">Kembali</a>
            </div>
        </form>
    </div>
